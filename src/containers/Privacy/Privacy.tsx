  ...
  return (
    <>
      <article>
        ...
        <p>
          At Pomodoro, we are committed to protecting your privacy and ensuring
          your personal information is safe and secure. This Privacy Policy
        ...
        <ol>
          ...
          <li>
            ...
            collect is used to: Provide and improve our services Customize your
            user experience Communicate with you, including sending updates and
            notifications Analyze usage patterns to enhance app functionality
          </li>
          ...
          circumstances: With Your Consent: When you provide explicit permission
          to share your information. For Legal Reasons: When required by law or
          ...
          <li>
            ...
            by posting the new policy on this page and updating the effective
            date.
          </li>
        </ol>
