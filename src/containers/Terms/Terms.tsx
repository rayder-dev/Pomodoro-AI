        ...
        <div className={Styles['wrapper']}>
          ...
          <ol>
            ...
            <li>
              ...
              any warranties of any kind. We do not guarantee that the app will
              be available at all times or that it will be free from errors or
              viruses. Use of the app is at your own risk.{' '}
            </li>
            <li>
              <strong>Intellectual Property</strong> All content within
            ...
            <li>
              <strong>No Liability</strong> We will not be liable for any
